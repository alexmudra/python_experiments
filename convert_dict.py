'''
Пользователь вводит любой текст, состоящий из любых исмволов, в том числе и русских букв.
...
my_dictionary = {'а': 'a', 'б': 'b', 'в': 'v', 'г': 'g', 'д': 'd', 'е': 'e', 'ж': 'zh', 'з': 'z', 'к': 'k', 'л': 'l', 'і': 'i', 'й': 'y', 'м': 'm', 'н': 'n', 'о': 'o', 'п': 'p', 'р': 'r', 'с': 's', 'т': 't', 'у': 'u', 'ф': 'f', 'х': 'h', 'ц': 'c', 'ч': 'ch', 'ш': 'sh', 'щ': 'sch', 'ь': '*', 'и': 'y', 'е': 'e', 'ю': 'ju', 'я': 'ya'}
a = input("Enter the EN or RU text: ")
x = ''

for i in a:
    if i in my_dictionary:
        x += my_dictionary[i]
    elif i.lower() in my_dictionary:
        x += my_dictionary[i.lower()].upper()
    else:
        x += i
print("Це наша відповідь :", x)

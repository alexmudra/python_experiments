...
#[0, 1, 3, 4, 5, 6, 7, 8, 9, 99]

#//////////////////////////////////////
"""
Дан список my_list, необходимо вывести на консоль все элементы этого списка по очереди, предварительно умножив их на 2.  
Задачу решить с помощью цикла for. Использовать переменную счётчик i.
...
# Створіть список, що містить кілька рядків зі стрічками. Наприклад, "абрикос", "банан", "вишня". Потім виведіть на екран кожен елемент цього списку на окремому рядку.
lst_fruits = ["абрикос", "банан", "вишня"]
for i in lst_fruits:
    print(i, sep='\n')
